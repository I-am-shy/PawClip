...
const zh: Dict = {
  ...
  'settings.hotkey.confirm': '确认',
  'settings.hotkey.confirmClear': '取消快捷键',
  'settings.hotkey.cancel': '取消',
  'settings.hotkey.needModifier': '需要一个修饰键（⌘ / ⌃ / ⌥ / ⇧）——裸键做全局热键会把那个键从整个系统吃掉。',
  'settings.hotkey.unsupportedKey': '这个键不能做全局热键，换一个字母或数字键试试。',
  'settings.hotkey.hint':
    '按下的组合先写在这里，点「确认」才生效；留空确认就是取消快捷键。Backspace 清空，Esc 取消。',
  ...
  'draft.purgeTitle': '彻底删除这条草稿？',
  'draft.purgeBody': '「{name}」删除后无法恢复。',
  'draft.archiveOne': '移入归档',
  'draft.saving': '保存中…',
  'draft.saved': '已保存',
  'draft.savedAt': '已保存 · {t}',
  ...
  'draft.image': '插入图片',
  'draft.imageResize': '拖动调整图片大小，双击恢复原始宽度',
...
const en: Dict = {
  ...
  'settings.hotkey.confirm': 'Confirm',
  'settings.hotkey.confirmClear': 'Remove hotkey',
  'settings.hotkey.cancel': 'Cancel',
  'settings.hotkey.needModifier':
    'A modifier is required (⌘ / ⌃ / ⌥ / ⇧) — a bare key as a global hotkey would swallow that key system-wide.',
  'settings.hotkey.unsupportedKey': 'That key can\'t be used as a global hotkey. Try a letter or digit.',
  'settings.hotkey.hint':
    'The combination is written here first and only takes effect on Confirm; confirming with it empty removes the hotkey. Backspace clears, Esc cancels.',
  ...
  'backup.rolledBack': 'Rolled back — {n} items deleted',
  ...
  'draft.purgeTitle': 'Delete this draft for good?',
  'draft.purgeBody': '“{name}” cannot be recovered once deleted.',
  'draft.archiveOne': 'Move to archive',
  'draft.saving': 'Saving…',
  'draft.saved': 'Saved',
  ...
  'draft.imageResize': 'Drag to resize; double-click to reset',
